...
export default function MatchCenterPage({ onCountryClick, onVenueNav }: { onCountryClick?: (name: string) => void; onVenueNav?: (venue: VenueData) => void }) {
  ...
  return (
    <div style={{ paddingTop: 64, minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      {/* FanDuel affiliate: sign up at https://www.fanduel.com/affiliates
          Replace YOUR_AFFILIATE_ID with your affiliate ID from the FanDuel Affiliate portal. */}
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '28px 24px 0' }}>
        <a
          href="https://www.fanduel.com/join?btag=YOUR_AFFILIATE_ID"
          target="_blank"
        ...
        >
          <div style={{
            ...
            background: 'linear-gradient(135deg, #0d1f0d 0%, #0a1a0a 50%, #071407 100%)',
            ...
            onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(102,187,106,0.45)'}
            onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(102,187,106,0.2)'}
          >
            {/* Background glow */}
            <div style={{
            ...
            <div style={{
              ...
              fontSize: 22, boxShadow: '0 0 20px rgba(102,187,106,0.25)',
            }}>
              🏆
            </div>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                ...
                Official Sports Betting Partner · 21+ Only · Please Gamble Responsibly
              </div>
              <div style={{
                fontFamily: 'var(--font-display)', fontSize: 18,
                color: 'var(--white)', lineHeight: 1,
              }}>
                BET ON EVERY WORLD CUP MATCH WITH FANDUEL
              </div>
            </div>
            ...
            <div style={{
              ...
              borderRadius: 8,
              whiteSpace: 'nowrap',
              boxShadow: '0 4px 20px rgba(102,187,106,0.2)',
            }}>
              BET NOW ↗
            </div>
          </div>
